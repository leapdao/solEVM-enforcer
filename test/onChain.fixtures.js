...
export default [
  ...
  // MSTORE
  {
    code: [ OP.PUSH32, ...split(leftPad('5567', 64)), OP.PUSH1, '01', OP.MSTORE, OP.PUSH1, '01', OP.MLOAD, OP.POP, OP.MSIZE ],
    pc: 35,
    step: 2,
  },
  // MLOAD
  ...
  {
    code: [
      OP.PUSH32, ...split('0102030405060708091011121314151617181920212223242526272829303132'), OP.PUSH1, '00', OP.MSTORE,
